...
#recastear una columna a otro tipo de dato
...
"Para revisar si en nuesto DataFrame existen datos faltantes podemos usar 
...
#se toma solo los valores completos, recordar que [filas, columnas]
...
# Esto hace lo mismo que las lineas de arriba del select
...
library(ggplot2)
#mtcars es un data que ya viene por default en ggplot2
names(mtcars)
head(mtcars)
