...
"Una maquina de ensamblaje, tiene una probabilidad de 0.15 de ensambar de forma 
...
pbinom(q = 4, size = 10, prob = 0.15, lower.tail = TRUE) #P(X<=4)

"d) ¿Cuál es la probabiliad de que por lo menos tres unidades se encuentren defectuosa?"
1 - pbinom(q = 2, size = 10, prob = 0.15)

"e) ¿Cuál es la probabilidad de que 2 o más pero 4 o menos unidades se encuentren defectuosas"
pbinom(q = 4, size = 10, prob = 0.15) - pbinom(q = 1, size = 10, prob = 0.15)
