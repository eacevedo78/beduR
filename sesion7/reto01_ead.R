...
#serie es explicado por el primer rezago de su comportamiento,
#es decir: y[t]=b*y[t-1] + w[t], donde b es el coeficiente del término
#autorregresivo y w es una serie ruído blanco.

#Coloca el número diez como semilla
set.seed(10)

#Simula un proceso AR(1) de la forma
#x[t] = 0.8 * x[t-1] + w[t] para t = 1, 2, ..., 200 y muestra gráficamente la
#serie de tiempo obtenida
