...
# NC es nivel de confianza
# EEE Existe Evidencia Estadistica

#La hipotesis nula: Ho <=, =, >=    se asume como verdadera hasta que se demuestre lo contrario
#La hipotesis alternativa Ha >, !=, <
...
#Niveles de confianza: 90%, 95% , 99%, o sea probabilidad de que no cometa
#error tipo I

#Nivel de Significancia (1-NC): 0.1, 0.05, 0.01 o sea probabilidad de cometer
#error tipo I

#Toma de decisión: Si pvalue >= significancia entonces No rechazo Ho
#                  Si pvalue < significancia entonces rechazo Ho


t.test(x = df$total_intl_calls, alternative = 'less', mu=4.54)
# A nivel de confianza del 90%, existe evidencia estadistica para 
# rechazar Ho, es decir, El promedio es menor a 4.54
...
# A nivel de confianza del 95% no existe evidencia estadistica para rechazar Ho.
...
#Para prueba de 2 colas, Nivel de significancia / 2
#Nivel significancia = 0.05 -> 0.05 / 2 = 0.025

#Conclusión: A niveles de confianza estandar (90%, 95%, 99%), no existe eviendia
#estadistica para rechazar Ho, es decir El promedio no es distinto (es igual) a 1.59
