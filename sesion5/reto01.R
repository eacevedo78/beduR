...
#cuales definen la forma de la distribución. El promedio y la varianza se calculan
#como: E(X) = a/(a+b) Var(x) = (ab)/((a+b+1)*(a+b)^2)
...
curve(dbeta(x,shape1=a, shape2=b),
      from = 0, to= 1, xlab="X", ylab="f(x)", main="Distribucón Beta"
      )
